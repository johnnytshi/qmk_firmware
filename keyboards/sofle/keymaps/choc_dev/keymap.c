...
[_LOWER] = LAYOUT( \
  ...
  KC_CAPS,   XXXXXXX, KC_1,   KC_2,  KC_3,     KC_PAST, _______,       _______, KC_LSTRT, KC_LEND, XXXXXXX, KC_PGUP, KC_PGDN, KC_PSCR, \
                   KC_0, KC_PDOT, KC_PSLS,     XXXXXXX, _______,       _______, XXXXXXX, _______, _______, _______\
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
led_config_t g_led_config = { {
  ...
  { 29, 7 },{ 29, 21 },{ 29, 36 },{ 29, 50 },{ 0, 64 },
  { 39, 62 },{ 78, 60 },{ 68, 48 },{ 68, 33 },{ 68, 19 },
  { 68, 5 },{ 107, 3 },{ 107, 17 },{ 107, 31 },{ 107, 46 },
  { 117, 62 },{ 156, 64 },{ 146, 48 },{ 146, 33 },{ 146, 19 },
  { 146, 5 },{ 185, 7 },{ 185, 21 },{ 185, 36 },{ 185, 50 },
...
static void render_shia(void) {
    static const char PROGMEM shia[3][ANIM_SIZE] = {
        {
            // 'ezgif', 32x41px
    ...
    if (timer_elapsed32(anim_timer) > ANIM_FRAME_DURATION) {
        ...
        oled_write_raw_P(shia[abs(2 - current_frame)], ANIM_SIZE);
    }
}
